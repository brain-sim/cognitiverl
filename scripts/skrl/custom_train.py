...
cfg = load_cfg_from_registry("CognitiveRL-Nav-v2", "env_cfg_entry_point")
# load and wrap the Isaac Lab environment
env = gymnasium.make("CognitiveRL-Nav-v2", cfg=cfg, render_mode=None)
env = wrap_env(env)
...
cfg["experiment"]["directory"] = "logs/skrl/CognitiveRL-Nav-v2"
